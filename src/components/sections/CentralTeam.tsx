...
const CentralTeam: React.FC = () => {
  ...
  return <section id="central-team" ref={sectionRef} className="py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <header className="mb-8 md:mb-10 text-center">
          <ScrollFloat containerClassName="text-center font-extrabold tracking-tight" textClassName="text-[clamp(2rem,6vw,3.5rem)]">
            Central Team
          </ScrollFloat>
          <p className="mt-2 text-sm text-muted-foreground">TechSociety Core • 2025-26</p>
        </header>
