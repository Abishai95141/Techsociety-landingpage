...
const ProjectsSection: React.FC = () => {
  ...
  return <section id="projects" aria-labelledby="projects-title" className="mx-auto max-w-6xl px-4 md:px-6 py-20 md:py-28">
              ...
              <Card className="rounded-2xl bg-card text-card-foreground shadow-sm transition-transform duration-200 will-change-transform motion-safe:group-hover:-translate-y-0.5">
                ...
                <CardContent className="relative px-6 md:px-7 pb-6 md:pb-7 pt-0">
                  <div className="flex flex-wrap gap-2">
                    {tags.map(t => <Button key={t} type="button" variant="pill" size="sm" className="border border-border bg-card text-foreground/90" aria-label={t}>
                        {t}
                      </Button>)}
                  </div>
                </CardContent>
